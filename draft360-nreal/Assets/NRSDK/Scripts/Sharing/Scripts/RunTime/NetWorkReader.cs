...
namespace NRToolkit.Sharing
{
    ...
    public class NetworkReader
    {
        ...
        public void ReadSynTransform(ref SynTransform transform)
        {
            transform.position = ReadVector3();
            transform.rotation = ReadQuaternion();
        }

        public Pose ReadSynTransform()
        {
            Pose pose = new Pose();
            pose.position = ReadVector3();
            pose.rotation = ReadQuaternion();
            return pose;
        }
